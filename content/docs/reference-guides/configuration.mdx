...
<Cards>
  <Card title="Documentation Generation">
    Extract project info for README generation and API docs
  </Card>
  
  <Card title="Deployment Automation">
  ...
  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm font-mono text-purple-600 dark:text-purple-400">--dep a,b,c</td>
