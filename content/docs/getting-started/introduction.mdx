...
<Cards>
  ...
  <Card title="SQLPage Integration" href="/docs/use-cases/sqlpage-data-app">
    Build complete database-driven web applications with automatic routing and navigation.
  </Card>
  
  <Card title="Audit-Ready Evidence" href="/docs/use-cases/audit-complains">
...
<Cards>
  ...
  <Card title="Executable Runbooks">
