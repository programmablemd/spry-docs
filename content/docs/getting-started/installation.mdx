...
<Tabs items={['Homebrew', 'Binary Download', 'Deno']}>
  <Tab value="Homebrew">
  ...
  <Tab value="Deno">
    ...
    If you have [Deno 2.5+](https://deno.land) installed, you can run Spry without installation:
    ...
    - Quick testing without committing to an installation
    - CI/CD environments where you want to use specific versions
    - Containerized deployments

    <Callout>
    The Deno runtime is required for this method. Install Deno from [deno.land](https://deno.land) if you don't have it already.
    </Callout>
  </Tab>
</Tabs>
...
<Callout type="error">
**"Command not found: spry"**

The Spry binary is not in your PATH. Try:
1. Restart your terminal after installation
2. Check if Homebrew's bin directory is in your PATH: `echo $PATH | grep brew`
3. Use the full path: `./spry.ts` (when using project-local installation)
</Callout>
...
xattr -d com.apple.quarantine /usr/local/bin/spry
```
