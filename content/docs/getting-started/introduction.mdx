...
<Cards>
  ...
  <Card title="Audit-Ready Evidence" href="#audit-ready-evidence">
    Capture execution results as verifiable artifacts for compliance frameworks like CMMC, SOC2, and ISO 27001.
  </Card>
</Cards>

### [Executable Markdown](/docs/core-concepts/executable-markdown)
...
### [Task Dependencies](/docs/core-concepts/task-orchestration)
...
### [SQLPage Integration](/docs/use-cases/sqlpage-data-app)
...
### [Audit-Ready Evidence](/docs/use-cases/audit-complains)
...
<Cards>
  <Card title="Policies as Code" href="/docs/use-cases/audit-complains">
    Create verifiable test cases for compliance frameworks with automated evidence capture.
  </Card>
  
  <Card title="Data Applications" href="/docs/use-cases/sqlpage-data-app">
    Build SQLite or PostgreSQL-backed dashboards with SQLPage integration.
  </Card>
  
  <Card title="Executable Runbooks" href="/docs/use-cases/devops-runbook">
