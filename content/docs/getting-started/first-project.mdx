...
```
sales-dashboard/
├── spry.ts                 # CLI wrapper for running Spry commands
...
<Cards>
  <Card title="Frontmatter Configuration" href="/docs/core-concepts/spryfiles#metadata-with-yaml-frontmatter">
  ...
  <Card title="Executable Cells" href="/docs/core-concepts/code-cells#executable-languages">
    Running bash scripts to create and populate databases
  </Card>
  
  <Card title="Materializable Cells" href="/docs/core-concepts/code-cells#materializable-languages">
...
|---------|-------------------|---------------------|
| **Frontmatter** | `sqlpage-conf` with database URL and port | [Configuration Reference](/docs/reference/configuration) |
| **Environment Variables** | `${env.SPRY_DB}` interpolation | [Core Concepts](/docs/core-concepts/spryfiles) |
| **Executable Cells** | `bash prepare-db` task | [Code Cells](/docs/core-concepts/code-cells) |
| **Materializable Cells** | `sql index.sql` page definition | [Cell Types](/docs/reference/cell-types) |
| **PARTIAL Directive** | `global-layout.sql` injected everywhere | [Directives](/docs/reference/directives) |
| **Route Attributes** | `{ route: { caption: "Home" } }` metadata | [SQLPage Integration](/docs/guides/sqlpage) |
...
<Cards>
  <Card title="Learn More About Spryfiles" href="/docs/core-concepts/spryfiles">
  ...
  <Card title="Build Complex Workflows" href="/docs/guides/executable-runbooks">
...
- **[Task Dependencies](/docs/core-concepts/task-dependencies)** - Build complex workflows
- **[SQLPage Integration](/docs/guides/sqlpage)** - Deep dive into SQLPage applications
- **[Production Deployment](/docs/guides/deployment)** - Best practices for production
- **[Example Projects](/docs/examples)** - More complete applications to learn from
