...
<Cards>
  <Card title="Remark Plugins">
    Process and enrich Markdown during parsing
  </Card>
  <Card title="Task Directive Inspectors">
    Define how code cells become executable
  </Card>
  <Card title="Event Bus Listeners">
...
- **[GitHub Issues](https://github.com/programmablemd/spry/issues)** — Report bugs or request features
- **[Discussions](https://github.com/programmablemd/spry/discussions)** — Ask questions and share ideas
- **[Discord](https://discord.gg/XtmFha9P)** — Real-time chat with the community
- **[Documentation](/docs)** — Keep this guide handy as a reference
