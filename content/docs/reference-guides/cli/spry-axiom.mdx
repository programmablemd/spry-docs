...
spry axiom web-ui runbook-cmd.md
...
# Inspect custom file
spry axiom inspect runbook-cmd.md
...
spry axiom projection runbook-cmd.md
...
spry axiom shebang runbook-cmd.md
...
<Tabs items={['Explore and Analyze', 'Convert to Executable']}>
  ...
  <Tab value="Convert to Executable">
    ...
    spry axiom shebang ./my-runbook.md --dry-run

    # Add shebang to make it executable
    spry axiom shebang ./my-runbook.md

    # With custom entrypoint
    spry axiom shebang ./my-runbook.md --entrypoint ./custom-launcher.ts
