...
<Cards>
  <Card title="FlexibleProjection" icon="Database">
    Best for document analysis, querying, and building custom tools
  </Card>
  
  <Card title="PlaybookProjection" icon="Play">
...
<Cards>
  <Card title="Pass Through Edges" icon="ArrowRight">
    Always yield previous edges unless you're intentionally filtering
  </Card>
  
  <Card title="Use Generators" icon="Zap">
  ...
  <Card title="Document Semantics" icon="BookOpen">
...
<Cards>
  <Card title="Architecture Guide" href="/docs/architecture">
    Understand how Axiom fits into Spry's overall architecture
  </Card>
  
  <Card title="Code Cells" href="/docs/core-concepts/code-cells">
    Learn how code cells are processed and executed
  </Card>
  
  <Card title="Task Dependencies" href="/docs/core-concepts/task-dependencies">
    Master dependency management and execution ordering
  </Card>
  
  <Card title="Projections" href="/docs/reference/projections">
    Deep dive into different projection types
  </Card>
</Cards>

<Callout type="success">
**You're Ready to Build Custom Rules**

With Axiom's flexible rule system, you can add any semantic relationships you need. Start with the built-in rules, then extend them for your domain-specific requirements.
</Callout>