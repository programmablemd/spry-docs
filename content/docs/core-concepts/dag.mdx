...
```bash
spry rb run --md Spryfile.md --visualize ascii-tree
```
...
```bash
spry rb run --md Spryfile.md --visualize mermaid-js > dag.mmd
```
...
```bash
spry rb run --md Spryfile.md --verbose markdown
```
...
```bash
spry rb run --md Spryfile.md --summarize > run-summary.json
```
